  ...
  return (
    <ToastProvider>
      <div className="flex flex-1 h-dvh relative">
        ...
        <main className="flex-1 min-w-0 overflow-y-auto overflow-x-hidden bg-shadow-glow">
          <div className="px-4 pt-14 pb-8 md:px-10 md:pt-8 max-w-[1400px] mx-auto w-full min-w-0">
